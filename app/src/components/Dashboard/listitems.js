...
export const BuyerNavItems = props => (
  <div>
    <ListItem
      button
      onClick={event => props.handleListItemClick(event, 0, "Dashboard")}
      selected={props.selectedIndex === 0}
    >
      <ListItemIcon style={{ color: "#FFFFFF" }}>
        <DashboardIcon />
    ...
    <ListItem
      button
      onClick={event => props.handleListItemClick(event, 1, "getQuote")}
    ...
    <ListItem
      button
      onClick={event => props.handleListItemClick(event, 2, "BoughtCars")}
      selected={props.selectedIndex === 2}
    >
      <ListItemIcon style={{ color: "#FFFFFF" }}>
        <BarChartIcon />
    ...
    <ListItem
      button
      onClick={event => props.handleListItemClick(event, 3, "BuyTokens")}
      selected={props.selectedIndex === 3}
    >
      <ListItemIcon style={{ color: "#FFFFFF" }}>
        <MonetizationOnIcon />
