...
const headCells = [
    ...
    { id: 'yourdeal', numeric: true, disablePadding: false, label: 'Your Deal' },
...
export default function PlaicedBids() {
                                ...
                                .map( ( row, index ) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.yourdeal}</TableCell>
                                            <TableCell align="right">{row.lowestdeal}</TableCell>
                                            <TableCell align="right"><Button style={{ "background-color": "rgb(25,123,189)", "color": "white" }}>Quote Price</Button></TableCell>
                                        </TableRow>
                                    );
                                } )}
                            {emptyRows > 0 && (
